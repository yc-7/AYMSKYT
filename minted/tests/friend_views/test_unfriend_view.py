...
class FriendViewTest(TestCase, LoginRequiredTester):
    ...
    def setUp(self):
        ...
        self.friend_request_id = 1
        self.url = reverse('decline_request', kwargs={'friend_request_id': self.friend_request_id})
    
    def test_unfriend_url(self):
        self.assertEqual(self.url, f'/decline_request/{self.friend_request_id}')

    def test_view_redirects_to_login_if_not_logged_in(self):
        self.assertLoginRequired(self.url)

    def test_successful_decline_friend_request(self):
        ...
        self.assertEqual(friend_request_start_count, friend_request_end_count+1)
